...
import { Storefront, Visibility, MoreVert, Refresh } from "@mui/icons-material";
...
interface FactoringMarketplaceTableProps {
  factoringId: string;
...
const FactoringMarketplaceTable = ({
  factoringId,
  onMetaChange,
}: FactoringMarketplaceTableProps) => {
  const { getFacturasByFactoringId, loading } = useFacturas();
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      setError(false);
      const response = await getFacturasByFactoringId({
        page: meta.page,
        limit: meta.limit,
        factoringId,
        ...
        {loading ? (
          ...
          >
            ...
            <Typography
              ...
              sx={{ color: "var(--color-fg-default-secondary)", fontWeight: 500 }}
            >
              No hay facturas disponibles en el marketplace.
            </Typography>
            <Typography
              variant="body2"
            ...
            {meta.lastPage > 1 && (
              ...
              >
                <FormControl size="small" sx={paginationSelectSx}>
                  <InputLabel id="factoring-marketplace-limit-label">
                    Filas por página
                  </InputLabel>
                  <Select
                    labelId="factoring-marketplace-limit-label"
...
export default FactoringMarketplaceTable;
