      ...
      >
        ...
        >
          ...
          >
            {rolesList.map((role) => (
              <RoleCard
                key={role.contexto === "empresa" ? role.empresaId : role.factoringId}
                roleId={role.contexto === "empresa" ? role.empresaId : role.factoringId}
                currentRoleId={currentRole?.contexto === "empresa" ? currentRole?.empresaId : currentRole?.factoringId}
